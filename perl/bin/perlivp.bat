...
#!perl
#line 29
    eval 'exec D:\Dokumente\GitHub\EnterpriseSolutionDevelopment\perl\bin\perl.exe -S $0 ${1+"$@"}'
...
my $perlpath = 'D:\Dokumente\GitHub\EnterpriseSolutionDevelopment\perl\bin\perl.exe';
