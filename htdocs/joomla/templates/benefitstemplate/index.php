...
<script type="text/javascript">
    ...
    function toggle() {
        ...
        if (bar.style.width == '150px') {
			...
			img.src = "<?php echo $this->baseurl;?>/templates/benefitstemplate/images/sidebar.png"
        // Otherwise, if the sidebar is already collapsed...
			...
			img.src = "<?php echo $this->baseurl;?>/templates/benefitstemplate/images/sidebar_close.png"
        }
    }
			...
			<?php if ($this->countModules('filter')) : ?>
				<div id="sidebar" style="width:150px;">
					<div id="handle">
						...
						alt ="Filter öffnen" onclick="toggle()" />
					</div>
